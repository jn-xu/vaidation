...
<body>
	<!--更改为你女朋友的头像-->
	<div class="cs">
		<img src="1.jpeg" id="logo">
	</div>
	<canvas class="canvas" width="1820" height="905"></canvas>
	<p class="text" style="color: #ed3073;">
		We've known each other for <br /> <span id="span_dt_dt"></span>
	</p>
	<script language="javascript">
    function show_date_time() {
        window.setTimeout("show_date_time()", 1000);
        BirthDay = new Date("3/1/2019");//这个日期是可以修改的
        today = new Date();
    ...
    var S = {
        init: function () {
			...
			//想说的话
            S.UI.simulate("|#countdown 3|顾|苏|祝|你|每|一|天|都|开|心|快|乐|#countdown 3|e|m|m|要|好|好|学|习|啊.");
	...
	<!-- <audio  autoplay="autoplay" src="/birthday/loving-you.mp3" loop controls>当前浏览器不支持音乐播放
</audio> -->
